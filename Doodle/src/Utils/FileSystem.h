...
// NOTE(Peter): This is really just a workaround Microsoft being extremely dumb and thinking no one would ever use the
// name CreateDirectory, etc... for a method...
//              If this causes any issues in the future we'll just remove these. I thought about renaming the methods,
//              but that doesn't really work for DeleteFile, MoveFile or CopyFile Seriously, I don't like using undef,
//              but it's just such an annoying situation.
