...
void CameraComponent::OnInspectorLayout()
{
...
rfl::Generic::Object CameraComponent::SerializeToObject() const
{
...
void CameraComponent::DeserializeFromObject(const rfl::Generic::Object &object)
{
